...
if __name__ == "__main__":
    ...
    resender = SocketHandler_NotificationDistributor(
        newSocketQueue, newSocketLock, udpQueue, udpLock, storageQueue, storageQueueLock, storageMode)
    ...
    while True:
        ...
        print("Active Thread Count Before enviarFile: %d" %
